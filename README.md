...
- 📱 Flutter & Android App Developer (Java)  
- 🎨 Focused on clean and user-friendly UI  
- 🔥 Working with Firebase backend services  
- 🌱 Learning app architecture and state management  
...
- 🎨 UI screens and complete user flows  
...
Firebase Auth • Realtime Database • Clean UI  

🔹 **Chat Application**  
Realtime Messaging • Firebase • Media Sharing  
